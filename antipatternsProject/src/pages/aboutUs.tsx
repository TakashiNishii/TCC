...
const people = [
    {
        ...
        role: '',
        imageUrl:
            'https://avatars.githubusercontent.com/u/70275261?v=4',
        twitterUrl: '#',
        linkedinUrl: '#',
    },
    {
        name: 'Ygor Takashi Nishi',
        role: '',
        imageUrl:
            'https://avatars.githubusercontent.com/u/49199986?v=4',
        twitterUrl: '#',
        linkedinUrl: '#',
    },
    {
        name: 'Gabriel Silverson Gomes',
        role: '',
        imageUrl:
            'https://avatars.githubusercontent.com/u/42818024?v=4',
        twitterUrl: '#',
        linkedinUrl: '#',
    },
]
            ...
            <div className="bg-white">
                <div className="mx-auto max-w-7xl py-12 px-6 lg:px-8 lg:py-24">
                    <div className="space-y-12">
                        <div className="space-y-5 flex flex-col  sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
                            ...
                            <img className="self-center justify-center text-center " src="./UFMS.png" alt="Logo da universidade" />
                        </div>
                        <ul
                            role="list"
                            ...
                            {people.map((person) => (
                                <li key={person.name}>
                                    <div className="space-y-4">
                                        <div className="aspect-w-3 aspect-h-2 h-80 w-80">
